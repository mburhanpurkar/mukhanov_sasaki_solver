...
class InfModel:
    ...
    def __init__(self, V, dV, k, phi0=30, psi0=-0.00000001, a0=1, efold=30, niter=4000, t0=0):
        self.V = V
        self.dV = dV
    ...
    def get_vk(self, plot_a=False, plot=False):
        ...
        bsmall = self.b[int(17.0 /self.efold * self.niter):int(28.0 /self.efold * self.niter)]
    ...
    def get_vt(self, plot_a=False, plot=False):
        ...
        bsmall = self.b[int(12.0 / self.efold * self.niter):int(21.0 / self.efold * self.niter)]
...
model = InfModel(V, dV, math.exp(24))
